  ...
  return (
    <div className="p-20 bg-main_teal flex justify-center">
      <div className="flex flex-col justify-center items-center w-6/12 text-center space-y-4">
        <h5 className="text-4xl font-bold">About Stop Shop</h5>
        <p className="text-6xl font-extrabold">Your Source for All Things</p>
        ...
        <img src="images/section-two-image.webp" alt="keyboard and coffee"  className="rounded h-auto"/>
